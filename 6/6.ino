...
// Loading the ESP8266WiFi library and the PubSubClient library #include <ESP8266WiFi.h>
...
// Connect an LED to each GPIO of your ESP8266 const int ledGPIO5 = 5;
...
// Basically it ensures that you ESP is connected to your broker void loop() {
if (!client.connected())
{
    reconnect();
}
