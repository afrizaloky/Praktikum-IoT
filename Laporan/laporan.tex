...
\begin{table}[H]
  ...
  \multicolumn{1}{|c|}{\cellcolor[HTML]{9B9B9B}Kriteria} & \multicolumn{1}{c|}{\cellcolor[HTML]{9B9B9B}MQTT}                                                      & \multicolumn{1}{c|}{\cellcolor[HTML]{9B9B9B}HTTP}                                                      \\ \hline
  Arsitektur                                             & Client/Broker                                                                                          & Client/Server                                                                                          \\ \hline
  Abstraksi                                              & Publish/Subscribe                                                                                      & Request/Response                                                                                       \\ \hline
  Ukuran Header                                          & 2 Byte                                                                                                 & Tidak terdefinisi                                                                                      \\ \hline
  Ukuran Pesan                                           & maksimum 256MB                                                                                         & \begin{tabular}[c]{@{}l@{}}Bisa sangat besar, \\ bergantung pada teknologi yang digunakan\end{tabular} \\ \hline
  Metode                                                 & \begin{tabular}[c]{@{}l@{}}Connect, Disconnect, Publish, \\ Subscribe, Unsubscribe, Close\end{tabular} & \begin{tabular}[c]{@{}l@{}}Get, Post, Head, Put, Patch, \\ Options, Connect, Delete\end{tabular}       \\ \hline
  Quality of Service                                     & \begin{tabular}[c]{@{}l@{}}QoS 0\\ QoS 1\\ QoS 2\end{tabular}                                          & Terbatas                                                                                               \\ \hline
